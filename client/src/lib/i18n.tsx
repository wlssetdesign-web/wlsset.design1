...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    "about.title": "من نحن",
    "about.heading": "WLSSET Design – حيث تتحول الأفكار إلى واقع",
    "about.subtitle": "نحوّل رؤيتك إلى تصاميم فريدة وذات تأثير قوي.",
    "about.aboutUsTitle": "من نحن",
    "about.aboutUsText": "في WLSSET Design، نؤمن أن لكل فكرة لحظتها التي تستحق أن تتألق فيها. ما بدأ بشغف بسيط وحلم جريء أصبح مهمتنا: تحويل أفكارك إلى تصاميم أصيلة تتحدث لغتك وتدفع مشاريعك إلى الأمام.",
    "about.storyTitle": "قصتنا",
    "about.storyText": "WLSSET أكثر من مجرد اسم؛ إنه يمثل بداية رحلة وطريقًا لا ينتهي. إنه انعكاس لجهدنا اليومي وطموحنا المستمر للتطور. نحن لا نصمم فقط؛ بل نبني الجسر بين الخيال والواقع.",
    "about.whatWeDoTitle": "ما الذي نقدمه",
    "about.goalTitle": "هدفنا",
    "about.goalText": "نسعى لأن نكون شركاءك في النجاح. نحن هنا لمساعدتك على تحويل فكرة \"ماذا لو\" إلى \"ما هو التالي\"، لصناعة مشاريع تجذب الانتباه وتترك أثرًا خالدًا.",
    "about.closingTitle": "ختامًا",
    "about.closingText": "WLSSET Design – فكرة تحققت. أطلق فكرتك اليوم… ودعها تصل إلى وجهتها.",
    "about.vision": "رؤيتنا",
