          ...
          {activeProject.title === "Khalil Barber Shop" ? (
            ...
            <div className="pt-32 pb-12">
              {activeProject.title !== "Dry Eyes Problems" && activeProject.title !== "تواصل" && (
                <div className="flex items-center justify-center px-4 py-20 m-0" style={{ backgroundColor: activeProject.title === "Kick Off" ? "#A51E1E" : activeProject.title === "مناحل نابلس" ? "#E8C832" : activeProject.title === "Al Mamlaka TV NFC" ? "#8B1A1A" : "#1D695A" }}>
