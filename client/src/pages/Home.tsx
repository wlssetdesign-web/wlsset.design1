  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center text-center px-4">
      ...
      >
        ...
        <div className="pt-8">
          <Link href="#services">
            <Button size="lg" className="text-lg px-8 py-6 rounded-full group bg-[#A30A0A] hover:bg-[#8B0808] shadow-lg hover:shadow-[0_0_30px_rgba(163,10,10,0.6)] transition-all duration-300">
              {t("hero.cta")}
